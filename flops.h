...
#define FMULS_GEMMT(n_, k_) (0.5*(n_+1) * (n_) * (k_))
#define FADDS_GEMMT(n_, k_) (0.5*(n_+1) * (n_) * (k_))


#define FMULS_SYMM(side_, m_, n_) ( ( (side_) == CblasLeft ) ? FMULS_GEMM((m_), (m_), (n_)) : FMULS_GEMM((m_), (n_), (n_)) )
#define FADDS_SYMM(side_, m_, n_) ( ( (side_) == CblasLeft ) ? FADDS_GEMM((m_), (m_), (n_)) : FADDS_GEMM((m_), (n_), (n_)) )
...
#define FMULS_UNMQR(m_, n_, k_, side_) (( (side_) == CblasLeft ) \
    ?  (2.*(n_)*(m_)*(k_) - (n_)*(k_)*(k_) + 2.*(n_)*(k_)) \
    :  (2.*(n_)*(m_)*(k_) - (m_)*(k_)*(k_) + (m_)*(k_) + (n_)*(k_) - 0.5*(k_)*(k_) + 0.5*(k_)))
#define FADDS_UNMQR(m_, n_, k_, side_) (( ((side_)) == CblasLeft ) \
...
#define FLOPS_ZGEMMT(n_, k_) (6. * FMULS_GEMMT((double)(n_), (double)(k_)) + 2.0 * FADDS_GEMMT((double)(n_), (double)(k_)) )
#define FLOPS_CGEMMT(n_, k_) (6. * FMULS_GEMMT((double)(n_), (double)(k_)) + 2.0 * FADDS_GEMMT((double)(n_), (double)(k_)) )
#define FLOPS_DGEMMT(n_, k_) (     FMULS_GEMMT((double)(n_), (double)(k_)) +       FADDS_GEMMT((double)(n_), (double)(k_)) )
#define FLOPS_SGEMMT(n_, k_) (     FMULS_GEMMT((double)(n_), (double)(k_)) +       FADDS_GEMMT((double)(n_), (double)(k_)) )
